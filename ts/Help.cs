...
namespace ts
{
    public static class Help
    {
        ...
        public static void PrintCfgHelp()
        {
            ...
            msg.Add("");
            msg.Add("/8    # Contained in an email address");
            msg.Add("/8    /email = [insert_nasty_regex_here]");
            msg.Add("");
            ...
            msg.Add("Regexes that contain {0} still require the tail query parameter.");
            msg.Add("Regexes that do not contain {0} do not require the tail parameter.");
            msg.Add("");
            msg.Add("/8    ts . /s /myParameterlessSwitch");
            msg.Add("");
            ...
            msg.Add("");
            msg.Add("/8    /code = /l /o cpp h hpp c cc cs js cxx hxx");
            msg.Add("");
            msg.Add("/6------------------------------------------------------------------------------------");
            msg.Add("");
